 ...
 * 
 */
var path = "topo_vms/";// 资源请求路径
var myappData;
var count = 1;
Ext.define('VMS.controller.vmsCtrl', {
	extend : 'Ext.app.Controller',
	views : ['vmsIndex'],// 声明该控制层要用到的view
...
//				url : "http://localhost:8080/cloudplatform//pages/cmp/topology/server/topo.json",
				url : restPath + "topo_vms/" + "getTopoServer?id="+server_id,
				timeout : 30000,// 30秒钟的查询超时
				success : function(data) {
					if (!Ext.isEmpty(data)) {
...
//		    		url:"http://localhost:8080/cloudplatform//pages/cmp/server/realstatus/realstatus_getServerDetail.json",
	    			url : restPath + "vmstatus/" + "vmDetail?id="+record.get("id"),
	    			method:'GET',
	    	        success : function() {
	    	        	//绘图
